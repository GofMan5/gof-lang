...
<Cards>
  <Card title="Быстрый старт" description="Установка, первый запуск и минимальный рабочий цикл." href="/ru/docs/getting-started" />
  <Card title="Обзор языка" description="Сначала пойми модель, потом заучивай синтаксис." href="/ru/docs/language-tour" />
  <Card title="Многопоточность" description="Текущий baseline задач, каналов и select." href="/ru/docs/concurrency" />
</Cards>
