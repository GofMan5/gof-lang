...
<Cards>
  ...
  <Card title="Обзор языка" description="Начни с ментальной модели." href="/ru/docs/language-tour" />
  <Card title="Многопоточность" description="Core differentiator." href="/ru/docs/concurrency" />
  <Card title="Тестирование" description="Shipped testing platform." href="/ru/docs/testing" />
