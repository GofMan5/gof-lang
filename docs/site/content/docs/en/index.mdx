...
<Cards>
  <Card title="Getting Started" description="Install or run locally, execute your first program, and learn the command flow." href="/en/docs/getting-started" />
  <Card title="Language Tour" description="Understand what the language is trying to be before you memorize syntax." href="/en/docs/language-tour" />
  <Card title="Concurrency" description="See the current task, channel, and select baseline with its real limits." href="/en/docs/concurrency" />
</Cards>
