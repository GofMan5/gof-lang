...
<Cards>
  ...
  <Card title="Language Tour" description="Start with the mental model." href="/en/docs/language-tour" />
  <Card title="Concurrency" description="The core differentiator." href="/en/docs/concurrency" />
  <Card title="Testing" description="The shipped testing platform." href="/en/docs/testing" />
