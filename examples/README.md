...
- `tcp_roundtrip.gof`: shipped `net` / `time` stdlib foundation with loopback listen/connect helpers, typed `SocketAddr` dialing, explicit deadlines, and loopback roundtrip I/O
