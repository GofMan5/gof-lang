...
test("highlights core gof syntax constructs", async () => {
  ...
  expectScope(lines, tokenLines, 92, "import", "keyword.control.import.gof");
  expectScope(lines, tokenLines, 92, "testing", "entity.name.namespace.gof");
  expectScope(lines, tokenLines, 94, "test", "keyword.declaration.test.gof");
  expectScope(lines, tokenLines, 94, "fn", "keyword.declaration.function.gof");
  expectScope(lines, tokenLines, 94, "smoke_test", "entity.name.function.gof");
  expectScope(lines, tokenLines, 94, "TestContext", "support.type.builtin.gof");
  expectScope(lines, tokenLines, 98, "fixture", "keyword.declaration.fixture.gof");
  expectScope(lines, tokenLines, 98, "module", "keyword.other.fixture-scope.gof");
  expectScope(lines, tokenLines, 98, "fn", "keyword.declaration.function.gof");
  expectScope(lines, tokenLines, 98, "shared_total", "entity.name.function.gof");
  expectScope(lines, tokenLines, 101, "fixture", "keyword.declaration.fixture.gof");
  expectScope(lines, tokenLines, 101, "test", "keyword.other.fixture-scope.gof");
  expectScope(lines, tokenLines, 101, "scratch_dir", "entity.name.function.gof");
  expectScope(lines, tokenLines, 101, "TestContext", "support.type.builtin.gof");
  expectScope(lines, tokenLines, 101, "TempDir", "support.type.builtin.gof");
});
